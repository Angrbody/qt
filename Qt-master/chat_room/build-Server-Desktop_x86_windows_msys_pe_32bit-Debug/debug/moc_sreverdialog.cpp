...
#include "../../../../chatroom_test/Server/sreverdialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SreverDialog_t, stringdata0) + ofs \
...
void SreverDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SreverDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SreverDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_SreverDialog.data,
    qt_meta_data_SreverDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SreverDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SreverDialog.stringdata0))
